...
export declare class USBDriver extends events.EventEmitter {
    ...
    private getDevices;
    blockDevice(device: usb.Device): void;
    unblockDevice(device: usb.Device): void;
    is_present(): boolean;
    open(): boolean;
    ...
    detach_all(): void;
    write(data: Buffer, source: string): void;
...
export declare class BaseSensor extends events.EventEmitter {
    ...
    detach(): void;
    protected write(data: Buffer, source: string): void;
